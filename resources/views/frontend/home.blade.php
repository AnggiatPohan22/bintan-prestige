...
<div class="home-page">
    ...
    @php
        ...
        $heroSlides = collect($heroSection?->activeMedia ?? [])->take(\App\Models\PageSection::MEDIA_LIMIT);
    ...
    <section
        ...
        @if($heroSlides->count()) data-section-has-media @endif
        @if($heroSlides->count() > 1) data-section-slider data-section-slider-interval="6500" @endif
