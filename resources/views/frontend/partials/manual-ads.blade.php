    ...
    <div class="home-container">
        <div class="bp-manual-ads__inner">
            ...
            <div class="bp-manual-ads__content">
                <span class="bp-manual-ads__label">{{ $section->label ?? 'Enjoy Summer Deals' }}</span>
                <h2 id="manual-ads-title" class="bp-manual-ads__title title-section">{{ $section->title ?? 'Up to 40% Discount!' }}</h2>
