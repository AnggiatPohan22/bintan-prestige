...
<div class="admin-page">
    <div class="admin-page-header">
        <div>
            ...
            <p class="admin-page-subtitle">
                Update admin account access and status.
            </p>
        </div>
    ...
    <div class="admin-form-card">
        <form action="{{ route('admin.users.update', $managedUser) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            @if($managedUser->isSuperAdmin() && $activeSuperAdminCount <= 1)
                <div class="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-800">
                    This is the only active Super Admin. It cannot be downgraded or deactivated until another active Super Admin exists.
                </div>
            @endif
