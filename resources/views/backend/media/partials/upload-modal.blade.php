...
<div x-show="uploadOpen" x-cloak class="fixed inset-0 z-[60]" style="display:none">
    ...
    <div class="absolute left-1/2 top-1/2 w-[92%] max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white p-6 shadow-2xl"
        ...
        <div class="mb-4 flex items-center justify-between">
            <h2 class="font-bold text-slate-900">Upload media</h2>
            <button type="button" x-on:click="closeUpload()" class="grid h-8 w-8 place-items-center rounded-full text-slate-400 hover:bg-slate-100 hover:text-slate-700">
        ...
        <label
            ...
            :class="dragging ? 'border-indigo-400 bg-indigo-50' : 'border-slate-300 hover:border-slate-400'"
