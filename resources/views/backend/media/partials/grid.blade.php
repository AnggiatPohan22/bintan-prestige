    ...
    <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        @foreach($media as $item)
            <button type="button"
                    ...
                    class="group overflow-hidden rounded-xl border border-admin bg-admin-card text-left transition hover:-translate-y-0.5 hover:border-violet-500/50">
                <div class="aspect-square overflow-hidden bg-admin-card">
                ...
                <div class="px-3 py-2">
                    ...
                    <p class="mt-0.5 flex items-center justify-between text-[11px] text-admin-secondary">
