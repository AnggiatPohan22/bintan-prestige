...
@section('content')
    <div class="admin-page">
        <div class="admin-page-header">
            <div>
                <h1 class="admin-page-title">Create Destination</h1>
        ...
        <div class="admin-form-card">
            ...
            >
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-[minmax(0,1fr)_180px]">
                    ...
                    <div>
                        <div class="flex h-28 w-full items-center justify-center rounded-xl border border-slate-200 bg-slate-100 text-sm text-slate-400">
                            No Image
                        </div>
                    </div>
                </div>
