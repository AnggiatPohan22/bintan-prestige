...
return [
    ...
    */
    'presets' => [
        ...
        // Owner's final scheme (2026-07-08): navy primary + gold accent,
        // dark navy sidebar on light content. Registered as a first-class
        // preset so appearance-UI preset actions can never silently revert
        // the dashboard to another scheme.
        'navy-light' => [
            'label'    => 'Navy Light',
            'mode'     => 'light',
            'tokens'   => [
                ...
                'bg-surface'            => '#FAFBFD',
                'bg-card'               => '#FFFFFF',
                'card-header-bg'        => '#E9EEF7',
                'bg-hover'              => '#EEF2F9',
                'border'                => '#DFE6F0',
                'border-md'             => '#C4D0E2',
                'border-strong'         => '#93A5C0',
                'text-primary'          => '#16233B',
                'text-secondary'        => '#3D4E6B',
                'text-muted'            => '#8294AE',
                'text-link'             => '#1E3A8A',
                'primary'               => '#1E3A8A',
                'primary-hover'         => '#162C68',
                'primary-text'          => '#FFFFFF',
                'btn-danger-bg'         => '#B91C1C',
                'btn-danger-hover'      => '#991B1B',
                'btn-secondary-bg'      => '#EEF2F9',
                'btn-secondary-text'    => '#16233B',
                'btn-soft-bg'           => 'rgba(30,58,138,0.10)',
                'btn-soft-text'         => '#1E3A8A',
                'pill-active-bg'        => '#1E3A8A',
                'pill-active-text'      => '#FFFFFF',
                'pill-hover-bg'         => 'rgba(30,58,138,0.10)',
                'pill-hover-border'     => 'rgba(30,58,138,0.10)',
                'pill-hover-text'       => '#1E3A8A',
                'bg-input'              => '#FFFFFF',
                'input-border'          => '#C4D0E2',
                'input-focus-ring'      => 'rgba(30,58,138,0.18)',
                'label-color'           => '#3D4E6B',
                'success'               => '#047857',
                'danger'                => '#B91C1C',
                'warning'               => '#B45309',
                'info'                  => '#0369A1',
                'table-header-bg'       => '#E9EEF7',
                'table-row-hover'       => '#EEF2F9',
                'table-border'          => '#DFE6F0',
                'alert-success-bg'      => '#ECFDF5',
                'alert-danger-bg'       => '#FEF2F2',
                'alert-warning-bg'      => '#FFFBEB',
                ...
                'modal-bg'              => '#FFFFFF',
                'modal-border'          => '#DFE6F0',
                'modal-overlay'         => 'rgba(11,31,59,0.45)',
                'topbar-bg'             => '#FFFFFF',
                'topbar-border'         => '#DFE6F0',
                'topbar-text'           => '#16233B',
                'sidebar-bg'            => '#0B1F3B',
                'sidebar-border'        => '#12294A',
                'sidebar-text'          => '#C7D3E8',
                'sidebar-text-hover'    => '#FFFFFF',
                'sidebar-active-bg'     => '#1E3A8A',
                'sidebar-active-text'   => '#FFFFFF',
                'sidebar-active-border' => '#C8A24A',
            ],
        ],
